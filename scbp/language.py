...
TEXTS = {
    ...
    's_er_acc_alle':   ('Alle Accounts', 'All accounts'),
    's_er_acc_n':      ('%s (%d Protokolle)', '%s (%d logs)'),
    's_er_acc_keiner': ('Noch keiner erkannt — das geht nach der ersten Anmeldung im Spiel.',
                          'None detected yet — this works after your first login in the game.'),
    's_er_acc_sagen':  ('Eigener Account: %s — die Protokolle werden neu eingelesen',
                          'Your account: %s — the logs are being read again'),
    's_er_fremd':      ('Baupläne anderer Accounts', 'Blueprints from other accounts'),
    's_er_fremd_h':    ('Baupläne, die nur in Protokollen eines anderen Accounts stehen, aber in deinem Bestand gelandet sind.',
                          'Blueprints that only appear in another account\'s logs but ended up in your collection.'),
    's_er_fremd_sucht': ('Wird gesucht …', 'Searching …'),
    's_er_fremd_keine': ('Keine — dein Bestand ist sauber.', 'None — your collection is clean.'),
    's_er_fremd_n':    ('%d Baupläne: %s', '%d blueprints: %s'),
    's_er_fremd_weg':  ('Aus dem Bestand entfernen', 'Remove from collection'),
    's_er_fremd_frage': ('Diese %d Baupläne stehen nur in Protokollen anderer Accounts:\n\n%s\n\nAus dem Bestand entfernen? Hast du einen davon doch selbst, hakst du ihn danach einfach wieder ab.',
                          'These %d blueprints only appear in other accounts\' logs:\n\n%s\n\nRemove them from your collection? If you do own one of them yourself, just tick it again afterwards.'),
    's_er_fremd_ok':   ('%d Baupläne aus dem Bestand entfernt', '%d blueprints removed from your collection'),
