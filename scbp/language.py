...
TEXTS = {
    ...
    's_di_ab_scan_t':  ('Scan-Bilder mitschicken?', 'Send scan images too?'),
    's_di_ab_scan':    ('Du hast %d Scan-Bilder angelernt. Mitgeschickt helfen sie, die Signatur-Erkennung für alle zu verbessern.\n\nEs ist nur der kleine Ausschnitt um die Zahl, mit der richtigen Zahl im Dateinamen — nichts vom übrigen Bildschirm.\n\nMitschicken?',
                        'You have taught %d scan images. Sent along, they help improve signature recognition for everyone.\n\nIt is only the small crop around the number, with the correct number in the file name — nothing else from your screen.\n\nSend them too?'),
    ...
    'b_scan':            ('%s · Bereich %s · %d eigene Ziffernbilder (%d Ziffern) · %d Scan-Bilder · zuletzt %s · Skalierung %s',
                          '%s · area %s · %d own digit images (%d digits) · %d scan images · last %s · scale %s'),
