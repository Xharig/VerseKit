...
| <img src="assets/symbole/22/abhaken-gruen.png" width="22" alt=""> **Updates itself** | Checks for new versions every 30 minutes and installs them on its own — **never while Star Citizen is running**, it waits until the game is closed. Can be switched off. With „What's new" to read up on, including older releases |
